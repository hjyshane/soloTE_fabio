...
#$ -o /igm/home/hxy008/SoloTE/solote_seurat.log           # Save combined stdout/stderr to this log file


# Load the R module (adjust for your environment)
module purge
module load R-4.3.3 ## change this to curret R version
Rscript /igm/home/hxy008/SoloTE/OUTPUTS/Code/01__Create_Seurat_loop.R ## change the R script path of yours
